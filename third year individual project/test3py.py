...
class Q_agent():
    def __init__(self):
        ...
        self.action_dict={'-35':0,'-15':1,'0':2,'15':3,'35':4}
        ...
        self.q_array=0    #the vectorised 2D np array version of the q table
        self.feature_matrix=0 #the feature matrix for input to NNs
...
#                 inner_count+=1
            ...
            sum_reward=0
            counter+=1
        #self.q_array=self.q_table_converter(self.q_values)
        self.feature_matrix=self.feature_matrix_generator(self.q_values)
        pass
...
if __name__=="__main__":
    ...
    plt.plot(list(range(len(testq.sum_reward_list[500:]))),testq.sum_reward_list[500:])
    plt.xlabel('episode number')
    plt.ylabel('sum of rewards per episode')
    plt.show()
    #savetxt('feature_matrix_test0.csv',testq.feature_matrix, delimiter=',')